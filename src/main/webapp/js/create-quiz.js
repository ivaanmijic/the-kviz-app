...
//Quiz Image
    ...
    quizInput.addEventListener('change', () => {
        ...
        if (file) {
            ...
            quizPreview.removeAttribute('data-imageSet');
        }
    });
...
//Questions
    ...
    function addQuestion() {
        ...
        wrapper.innerHTML =
            ...
            '<sl-radio-group class="radio-group" name="qcnt" value="1">' +
            '<div class="answers">' +
    ...
    function getDragAfterElement(container, y) {
        const draggableElements = [...container.querySelectorAll('sl-details:not(.dragging)')];
