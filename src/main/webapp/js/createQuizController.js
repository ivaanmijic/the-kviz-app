...
class QuizForm{
    ...
    bindEvents(){
        ...
        this._imageListener();
        this._toggleDetail();
        document.getElementById('add-question-button').addEventListener('click',() => {this.addQuestion()});
        document.getElementById("submitQuiz").addEventListener('click', (e)=>{this._createQuiz(e)})
    }
